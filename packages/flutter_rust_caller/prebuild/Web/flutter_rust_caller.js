 ...
 * @returns {string}
 */
export function rust_call_wasm(method, param_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ptr1 = passStringToWasm0(param_json, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
        const len1 = WASM_VECTOR_LEN;
        wasm.rust_call_wasm(retptr, ptr0, len0, ptr1, len1);
 ...
 */
export function rust_call_async_wasm(method, param_json) {
    const ptr0 = passStringToWasm0(method, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(param_json, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.rust_call_async_wasm(ptr0, len0, ptr1, len1);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_1ca5cb5fe56d1eea = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('flutter_rust_caller_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
